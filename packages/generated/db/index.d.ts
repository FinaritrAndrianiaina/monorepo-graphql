...
export namespace Prisma {
  ...
  */
  ...
  export type recipeGetPayload<S extends boolean | null | undefined | recipeArgs> =
    ...
    P extends keyof recipe ? recipe[P] : never
  } 
      : recipe


  type recipeCountArgs = 
  ...
  export interface recipeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<recipeGetPayload<T>>>
   ...
   */
  export class Prisma__recipeClient<T, Null = never> implements Prisma.PrismaPromise<T> {
  ...
  export type recipeWhereInput = {
    ...
    decription?: StringNullableFilter | string | null
  ...
  export type recipeScalarWhereWithAggregatesInput = {
    ...
    decription?: StringNullableWithAggregatesFilter | string | null
