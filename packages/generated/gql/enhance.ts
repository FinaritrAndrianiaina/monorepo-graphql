...
const modelsInfo = {
  Recipe: ["id", "title", "decription", "creationDate"]
};
...
const outputsInfo = {
  ...
  RecipeGroupBy: ["id", "title", "decription", "creationDate", "_count", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  RecipeCountAggregate: ["id", "title", "decription", "creationDate", "_all"],
  RecipeMinAggregate: ["id", "title", "decription", "creationDate"],
  RecipeMaxAggregate: ["id", "title", "decription", "creationDate"]
};
...
const inputsInfo = {
  RecipeWhereInput: ["AND", "OR", "NOT", "id", "title", "decription", "creationDate"],
  RecipeOrderByWithRelationInput: ["id", "title", "decription", "creationDate"],
  RecipeWhereUniqueInput: ["id"],
  RecipeOrderByWithAggregationInput: ["id", "title", "decription", "creationDate", "_count", "_max", "_min"],
  RecipeScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "title", "decription", "creationDate"],
  RecipeCreateInput: ["id", "title", "decription", "creationDate"],
  RecipeUpdateInput: ["id", "title", "decription", "creationDate"],
  RecipeCreateManyInput: ["id", "title", "decription", "creationDate"],
  RecipeUpdateManyMutationInput: ["id", "title", "decription", "creationDate"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  StringNullableFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  DateTimeFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  SortOrderInput: ["sort", "nulls"],
  RecipeCountOrderByAggregateInput: ["id", "title", "decription", "creationDate"],
  RecipeMaxOrderByAggregateInput: ["id", "title", "decription", "creationDate"],
  RecipeMinOrderByAggregateInput: ["id", "title", "decription", "creationDate"],
