...
const db_1 = require("@ficommerce/generated/db");
const gql_1 = require("@ficommerce/generated/gql");
...
__decorate([
    TypeGraphQL.Field(_type => gql_1.DecimalJSScalar, {
        nullable: false
    }),
    __metadata("design:type", db_1.Prisma.Decimal)
