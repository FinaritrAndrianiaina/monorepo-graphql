 ...
 */
const documents = {
    "fragment ProductsFullIem on Products {\n  id\n  price\n  createdAt\n  name\n  description\n  owner {\n    email\n  }\n}": types.ProductsFullIemFragmentDoc,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ProductsFullIem on Products {\n  id\n  price\n  createdAt\n  name\n  description\n  owner {\n    email\n  }\n}"): (typeof documents)["fragment ProductsFullIem on Products {\n  id\n  price\n  createdAt\n  name\n  description\n  owner {\n    email\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
